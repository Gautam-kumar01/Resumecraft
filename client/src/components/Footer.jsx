                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li><Link to="/contact" className="hover:text-orange-500 transition-colors">Career Advice</Link></li>
                            <li><Link to="/templates" className="hover:text-orange-500 transition-colors">Resume Formats</Link></li>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center text-sm gap-6">
                        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-slate-400">
                            ...
                            <div className="flex gap-6">
                                ...
                                <Link to="/privacy" className="hover:text-slate-900 dark:hover:text-white transition-colors">Cookie Policy</Link>
                            </div>
                        </div>

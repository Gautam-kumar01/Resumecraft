            ...
            <div className="grid md:grid-cols-2 gap-12">
                {starters.map((template) => (
                    <div key={template.id} className="group flex flex-col md:flex-row glass-effect rounded-[2.5rem] border border-white/80 hover:border-primary/40 transition-all duration-700 hover:shadow-2xl hover:shadow-primary/10 overflow-hidden">
                        ...
                        {/* Visual Preview Side */}
                        <div className="md:w-[45%] bg-slate-900 p-10 flex flex-col justify-between relative overflow-hidden shrink-0">
                            ...
                            <div className="relative z-10">
                                <div className="text-white/30 text-[10px] font-black uppercase tracking-[0.2em] mb-6 flex items-center">
                            ...
                            <div className="relative z-10">
                                <div className="text-white/50 text-[10px] font-bold uppercase tracking-wider mb-3">Core Industry</div>
                                <div className="inline-flex items-center px-4 py-2 rounded-2xl bg-white/10 border border-white/10 text-white text-[11px] font-bold">
                                    {template.industry}
                                </div>
                            </div>
                        </div>

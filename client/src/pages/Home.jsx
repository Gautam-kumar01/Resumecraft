...
const Home = () => {
    ...
    const mncCards = [
        ...
        { company: 'Creative teams', role: 'Designer', skills: ['Illustrator', 'After Effects', 'Brand'], image: 'https://images.unsplash.com/photo-1558655146-d09347e92766?auto=format&fit=crop&q=70&w=400' }
    ];
